...
class UnAccHostList(models.Model):
    ...
    key_tag = models.CharField(choices=(('acc','Accepted Key'),('unacc','Unaccepted Key'),('error','error')),default='unacc',max_length=15,verbose_name=u'salt-key状态')
...
class ErrorHostList(UnAccHostList):
    class Meta:
