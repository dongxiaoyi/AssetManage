...
class Asset(models.Model):
    ...
    asset_type = models.CharField(choices=asset_type_choices,max_length=64, default='server',verbose_name=u'服务器类型')
    name = models.CharField(verbose_name=u'名称',max_length=64,unique=True)
    sn = models.CharField(u'资产SN号',max_length=128, unique=True)
    manufactory = models.CharField(max_length=50,verbose_name=u'制造商',null=True, blank=True)
    manufactory_support_num = models.CharField(u'制造商支持电话',max_length=30,blank=True)
    all_ram_size = models.IntegerField(verbose_name=u'内存总量',default=0)
...
class Server(models.Model):
    ...
    sub_asset_type = models.SmallIntegerField(choices=sub_assset_type_choices,verbose_name=u"服务器类型",default=0)
...
class NetworkDevice(models.Model):
    ...
    device_detail = UEditorField(verbose_name=u'设备详情配置', width=800, height=250,
                          imagePath="asset/ueditor/image/",
                          filePath="asset/ueditor/file/",
                          default='')
...
class Contract(models.Model):
    ...
    detail = UEditorField(verbose_name=u'合同详细', width=800, height=250,
                          imagePath="asset/ueditor/image/",
                          filePath="asset/ueditor/file/",
                          default='')
...
class NewAssetApprovalZone(models.Model):
    ...
    asset_type = models.CharField(choices=asset_type_choices,max_length=64,blank=True,null=True,verbose_name=u'服务器类型')
    ...
    ram_size = models.IntegerField(blank=True,null=True,verbose_name=u'内存大小')
    cpu_model = models.CharField(max_length=128,blank=True,null=True,verbose_name=u'CPU型号')
    cpu_count = models.IntegerField(blank=True,null=True,verbose_name=u'CPU个数')
    cpu_core_count = models.IntegerField(blank=True,null=True,verbose_name=u'CPU核心数')
    os_distribution =  models.CharField(max_length=64,blank=True,null=True,verbose_name=u'发行系统版本')
    ...
    data = UEditorField(verbose_name=u'资产数据', width=800, height=250,
                          imagePath="asset/ueditor/image/",
                          filePath="asset/ueditor/file/",
                          default='')
