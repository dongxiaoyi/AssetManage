...
#from djcelery.utils import is_database_scheduler, make_aware
#
#try:
...
#    )
#
#class IntervalScheduleAdminx(object):
...
#    #readonly_fields = ['action',]
#    refresh_times = [3,5]
#xadmin.site.register(IntervalSchedule,IntervalScheduleAdminx)
#
#
#class CrontabScheduleAdminx(object):
...
#    #readonly_fields = ['action',]
#    refresh_times = [3,5]
#xadmin.site.register(CrontabSchedule,CrontabScheduleAdminx)
#
#
...
#
#class PeriodicTaskAdminx(object):
...
#xadmin.site.register(PeriodicTask,PeriodicTaskAdminx)
#
#class WorkerStateAdminx(object):
#    can_add = True
#    detail_title = _('Node detail')
#    list_page_title = _('Worker Nodes')
#    list_display = ('hostname','last_heartbeat')
#    refresh_times = [3,5]
...
#        return actions
#xadmin.site.register(WorkerState,WorkerStateAdminx)
#
#
#class TaskStateAdminx(object):
...
#
#    def get_actions(self, request):
#        actions = super(TaskStateAdminx, self).get_actions(request)
#        actions.pop('delete_selected', None)
#        return actions
#
#    def get_queryset(self, request):
#        qs = super(TaskStateAdminx, self).get_queryset(request)
#        return qs.select_related('worker')
#xadmin.site.register(TaskState,TaskStateAdminx)
#